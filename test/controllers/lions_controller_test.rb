...
class LionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lion" do
    assert_difference('Lion.count') do
      post lions_url, params: { lion: { content: @lion.content, name: @lion.name, title: @lion.title } }
    end
  ...
  test "should update lion" do
    patch lion_url(@lion), params: { lion: { content: @lion.content, name: @lion.name, title: @lion.title } }
